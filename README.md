...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-draftd-app.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-draftd-app)

This repository contains the source code for the [Draftd](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.draftd.app).

Please see the [issues](https://github.com.draftd.app/com-draftd-app/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about Draftd? Ask away on the [com-draftd-app discussion forum](https://groups.google.com/forum/#!forum/com-draftd-app).

<a href="https://play.google.com/store/apps/details?id=com.draftd.app" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.draftd.app__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.draftd.app__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.draftd.app.R__) will now be renamed
...
signed with a different key.  Manually uninstall Draftd from your device and
...
Draftd is a result of a template project I've developed over the years as well as
...
Draftd is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.draftd.app/com-draftd-app/contributors) on
...
[pull requests](https://github.com.draftd.app/com-draftd-app/pulls).
